...
- Giữ **Live Preview** và tab **Gemini** mở song song: chụp → gửi `prompt.md` + file `.md` + ảnh → dán output → reload preview
...
7. Lưu → reload **Live Preview** → **làm lại các câu vừa nhập** để tự test
